...
const Learning = () => {
    ...
    const elements = [
        ...
        { symbol: 'Li', name: 'Lithium', number: 3, description: 'Lithium is a soft, silvery metal used in rechargeable batteries, essential for modern technology.', trivia: 'Lithium is so soft you can cut it with a knife!', image: 'https://periodictable.com/Samples/003.3/s9s.JPG', application: 'Powers smartphones, laptops, and electric cars.', row: 2, col: 1 },
        { symbol: 'Be', name: 'Beryllium', number: 4, description: 'Beryllium is a rare metal that is essential for plant growth and has unique properties in high-tech materials.', trivia: 'Did you know? Beryllium is used in aerospace components for its lightweight properties!', image: 'https://periodictable.com/Samples/004.1/s9s.JPG', application: 'Used in aerospace and nuclear reactors.', row: 2, col: 2 },
        { symbol: 'B', name: 'Boron', number: 5, description: 'Boron is a rare element that is essential for plant growth and has unique properties in high-tech materials.', trivia: 'Did you know? Boron is used in borosilicate glass, which is highly heat resistant!', image: 'https://periodictable.com/Samples/005.6/s12s.JPG', application: 'Used in detergents, semiconductors, and glassmaking.', row: 2, col: 13 },
        { symbol: 'C', name: 'Carbon', number: 6, description: 'Carbon is the basis of all known life on Earth, forming the backbone of complex molecules like DNA.', trivia: 'Carbon exists as diamond, one of the hardest substances, and graphite, one of the softest.', image: 'https://periodictable.com/Samples/006.x4/s9s.JPG', application: 'Found in fuels, plastics, and advanced materials like graphene.', row: 2, col: 14 },
        { symbol: 'N', name: 'Nitrogen', number: 7, description: 'Nitrogen is a major component of the atmosphere, vital for the production of proteins and DNA in living organisms.', trivia: "Nitrogen makes up about 78% of Earth's atmosphere but is inert in its natural form.", image: 'https://periodictable.com/Samples/007.8/s9s.JPG', application: 'Used in fertilizers, cryogenics, and industrial processes.', row: 2, col: 15 },
        { symbol: 'O', name: 'Oxygen', number: 8, description: 'Oxygen is essential for respiration in most life forms and is a major component of water.', trivia: 'Oxygen makes up around 21% of Earth\'s atmosphere.', image: 'https://periodictable.com/Samples/008.8/s12s.JPG', application: 'Vital for respiration and combustion.', row: 2, col: 16 },
        ...
        { symbol: 'Mg', name: 'Magnesium', number: 12, description: 'Magnesium is a light metal used in many alloys, especially in the automotive and aerospace industries.', trivia: 'Magnesium burns with a bright white light!', image: 'https://periodictable.com/Samples/012.15/s9s.JPG', application: 'Used in alloys for aircraft, cars, and in fireworks.', row: 3, col: 2 },
        ...
        { symbol: 'Si', name: 'Silicon', number: 14, description: 'Silicon is a semiconductor material critical in electronics and computing.', trivia: 'Silicon chips are used in almost all modern electronic devices!', image: 'https://periodictable.com/Samples/014.12/s9s.JPG', application: 'Used in computer chips, solar panels, and glassmaking.', row: 3, col: 14 },
        { symbol: 'P', name: 'Phosphorus', number: 15, description: 'Phosphorus is a non-metal essential for life, especially for energy storage in cells as ATP.', trivia: 'Phosphorus glows in the dark when exposed to air!', image: 'https://periodictable.com/Samples/015.6/s9s.JPG', application: 'Used in fertilizers, detergents, and in steel production.', row: 3, col: 15 },
        { symbol: 'S', name: 'Sulfur', number: 16, description: 'Sulfur is an essential element for life and is commonly found in proteins and enzymes.', trivia: 'Sulfur compounds are responsible for the characteristic smell of rotten eggs!', image: 'https://periodictable.com/Samples/NativeSulfur/s9s.JPG', application: 'Used in sulfuric acid production, fertilizers, and vulcanized rubber.', row: 3, col: 16 },
        { symbol: 'Cl', name: 'Chlorine', number: 17, description: 'Chlorine is a halogen element often used in disinfectants and bleach due to its strong oxidative properties.', trivia: 'Chlorine gas was used as a chemical weapon during World War I!', image: 'https://periodictable.com/Samples/017.9/s7s.JPG', application: 'Used in water purification, disinfectants, and bleach.', row: 3, col: 17 },
        ...
        { symbol: 'K', name: 'Potassium', number: 19, description: 'Potassium is a soft, silvery metal that is essential for the proper function of cells and is found in many foods.', trivia: 'Potassium is highly reactive, especially with water!', image: 'https://periodictable.com/Samples/019.6/s9s.JPG', application: 'Used in fertilizers, salt production, and fireworks.', row: 4, col: 1 },
        { symbol: 'Ca', name: 'Calcium', number: 20, description: 'Calcium is a key element in bones and teeth, crucial for human health.', trivia: 'Calcium is the most abundant metal in the human body!', image: 'https://periodictable.com/Samples/020.6/s9s.JPG', application: 'Used in cement, calcium supplements, and in steel production.', row: 4, col: 2 },
        ...
        { symbol: 'Ge', name: 'Germanium', number: 32, description: 'Germanium is a semiconductor material used in transistors and fiber optics.', trivia: 'Germanium was once used in early computer chips before being replaced by silicon!', image: 'https://periodictable.com/Samples/032.10/s9s.JPG', application: 'Used in semiconductors, fiber optics, and infrared optics.', row: 4, col: 14 },
        { symbol: 'As', name: 'Arsenic', number: 33, description: 'Arsenic is a metalloid element often associated with toxic compounds.', trivia: 'Arsenic is highly toxic and was historically used in poison!', image: 'https://periodictable.com/Samples/033.7/s9s.JPG', application: 'Used in semiconductors and as a preservative in wood.', row: 4, col: 15 },
        { symbol: 'Se', name: 'Selenium', number: 34, description: 'Selenium is a non-metal used in electronics, glassmaking, and as a dietary supplement.', trivia: 'Selenium is essential for human health but can be toxic in high amounts!', image: 'https://periodictable.com/Samples/034.12/s9s.JPG', application: 'Used in electronics, glass production, and as a nutritional supplement.', row: 4, col: 16 },
        { symbol: 'Br', name: 'Bromine', number: 35, description: 'Bromine is a halogen element found in seawater and used in various chemical applications.', trivia: 'Bromine is one of only two elements that are liquids at room temperature!', image: 'https://periodictable.com/Samples/035.2/s9s.JPG', application: 'Used in flame retardants, pharmaceuticals, and in water treatment.', row: 4, col: 17 },
        { symbol: 'Kr', name: 'Krypton', number: 36, description: 'Krypton is a noble gas used in lighting and high-performance electrical equipment.', trivia: 'Krypton is used in some photographic flash lamps and in some types of neon signs!', image: 'https://periodictable.com/Samples/036.7/s7s.JPG', application: 'Used in lighting, photography, and in lasers.', row: 4, col: 18 },
        ...
        { symbol: 'Cd', name: 'Cadmium', number: 48, description: 'Cadmium is a soft, bluish-white metal that is toxic and primarily used in batteries and pigments.', trivia: 'Cadmium is often used in rechargeable nickel-cadmium batteries.', image: 'https://periodictable.com/Samples/048.20/s7s.JPG', application: 'Used in batteries, pigments, and coatings.', row: 5, col: 12 },
        { symbol: 'In', name: 'Indium', number: 49, description: 'Indium is a soft, malleable metal often used in electronics and touchscreens.', trivia: 'Indium makes a high-pitched "scream" when bent!', image: 'https://periodictable.com/Samples/049.7/s9s.JPG', application: 'Used in touchscreens, semiconductors, and coatings.', row: 5, col: 13 },
        { symbol: 'Sn', name: 'Tin', number: 50, description: 'Tin is a malleable metal often used as a protective coating and in alloys like bronze.', trivia: 'Tin has been used by humans for over 3,500 years!', image: 'https://periodictable.com/Samples/050.22/s9s.JPG', application: 'Used in soldering, plating, and making alloys such as bronze.', row: 5, col: 14 },
        { symbol: 'Sb', name: 'Antimony', number: 51, description: 'Antimony is a brittle metalloid commonly used in flame retardants and semiconductors.', trivia: 'The ancient Egyptians used antimony compounds in cosmetics.', image: 'https://periodictable.com/Samples/051.15/s9s.JPG', application: 'Used in flame retardants, semiconductors, and alloys.', row: 5, col: 15 },
        { symbol: 'Te', name: 'Tellurium', number: 52, description: 'Tellurium is a brittle metalloid used in alloys and as a semiconductor material.', trivia: 'Tellurium is one of the rarest stable elements on Earth!', image: 'https://periodictable.com/Samples/052.4/s9s.JPG', application: 'Used in thermoelectric devices, alloys, and semiconductors.', row: 5, col: 16 },
        { symbol: 'I', name: 'Iodine', number: 53, description: 'Iodine is a dark purple, non-metallic element essential for thyroid health in humans.', trivia: 'Iodine sublimates directly from solid to gas when heated!', image: 'https://periodictable.com/Samples/053.8/s9s.JPG', application: 'Used in disinfectants, photography, and as a dietary supplement.', row: 5, col: 17 },
        { symbol: 'Xe', name: 'Xenon', number: 54, description: 'Xenon is a noble gas used in lighting, medical imaging, and anesthesia.', trivia: 'Xenon is used in high-performance car headlights and strobe lights!', image: 'https://periodictable.com/Samples/054.15/s7s.JPG', application: 'Used in lighting, lasers, and medical imaging.', row: 5, col: 18 },
