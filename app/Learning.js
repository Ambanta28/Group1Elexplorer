...
const elements = [
    ...
    { symbol: 'Al', name: 'Aluminum', number: 13, description: 'Aluminum is a lightweight, corrosion-resistant metal commonly used in manufacturing and construction.', trivia: 'Aluminum is the most abundant metal in the Earth\'s crust!', image: 'https://upload.wikimedia.org/wikipedia/commons/d/d5/Aluminium_Foil.jpg', application: 'Used in packaging, construction, and aerospace.', row: 3, col: 3 },
    { symbol: 'Si', name: 'Silicon', number: 14, description: 'Silicon is a semiconductor material critical in electronics and computing.', trivia: 'Silicon chips are used in almost all modern electronic devices!', image: 'https://upload.wikimedia.org/wikipedia/commons/4/4e/Silicon-Crystal-Structure.jpg', application: 'Used in computer chips, solar panels, and glassmaking.', row: 3, col: 4 },
    { symbol: 'P', name: 'Phosphorus', number: 15, description: 'Phosphorus is a non-metal essential for life, especially for energy storage in cells as ATP.', trivia: 'Phosphorus glows in the dark when exposed to air!', image: 'https://upload.wikimedia.org/wikipedia/commons/9/9a/Phosphorus.jpg', application: 'Used in fertilizers, detergents, and in steel production.', row: 3, col: 5 },
    { symbol: 'S', name: 'Sulfur', number: 16, description: 'Sulfur is an essential element for life and is commonly found in proteins and enzymes.', trivia: 'Sulfur compounds are responsible for the characteristic smell of rotten eggs!', image: 'https://upload.wikimedia.org/wikipedia/commons/c/ca/Sulfur-Element.jpg', application: 'Used in sulfuric acid production, fertilizers, and vulcanized rubber.', row: 3, col: 6 },
    { symbol: 'Cl', name: 'Chlorine', number: 17, description: 'Chlorine is a halogen element often used in disinfectants and bleach due to its strong oxidative properties.', trivia: 'Chlorine gas was used as a chemical weapon during World War I!', image: 'https://upload.wikimedia.org/wikipedia/commons/e/eb/Chlorine-element.jpg', application: 'Used in water purification, disinfectants, and bleach.', row: 3, col: 7 },
    { symbol: 'Ar', name: 'Argon', number: 18, description: 'Argon is a noble gas used in light bulbs and as an inert atmosphere in welding and other processes.', trivia: 'Argon is the third most abundant gas in the Earth\'s atmosphere!', image: 'https://upload.wikimedia.org/wikipedia/commons/d/d5/Argon_Gas.jpg', application: 'Used in light bulbs, welding, and in the production of steel.', row: 3, col: 8 },
