...
const Learning = () => {
    ...
    const elements = [
        ...
        { symbol: 'Ce', name: 'Cerium', number: 58, description: 'Cerium is a soft, silvery metal that is the most abundant of the rare earth elements.', trivia: 'Cerium is used in catalytic converters and as a glass polishing agent.', image: 'https://upload.wikimedia.org/wikipedia/commons/9/91/Cerium.jpg', application: 'Used in catalytic converters, glass polishing, and alloys.', row: 8.5, col: 4 },
        ...
        { symbol: 'Eu', name: 'Europium', number: 63, description: 'Europium is a soft, silvery metal used to produce red and blue phosphors in TV and LED screens.', trivia: 'Europium is responsible for the red color in TV and LED screens!', image: 'https://upload.wikimedia.org/wikipedia/commons/5/57/Europium.jpg', application: 'Used in TV screens, LED lights, and anti-counterfeiting measures.', row: 8.5, col: 9 },
        ...
        { symbol: 'Tb', name: 'Terbium', number: 65, description: 'Terbium is a rare earth metal used in green phosphors for displays and solid-state devices.', trivia: 'Terbium is essential for producing bright green light in displays!', image: 'https://upload.wikimedia.org/wikipedia/commons/3/3a/Terbium.jpg', application: 'Used in displays, lasers, and solid-state devices.', row: 8.5, col: 11 },
        ...
        { symbol: 'Er', name: 'Erbium', number: 68, description: 'Erbium is a rare earth metal used in fiber-optic communication systems and lasers.', trivia: 'Erbium gives glass and ceramics a pink hue!', image: 'https://upload.wikimedia.org/wikipedia/commons/6/6a/Erbium.jpg', application: 'Used in fiber-optics, lasers, and coloring glass.', row: 8.5, col: 14 },
        { symbol: 'Tm', name: 'Thulium', number: 69, description: 'Thulium is a rare earth metal used in portable X-ray devices and lasers.', trivia: 'Thulium is the least abundant of the rare earth elements!', image: 'https://upload.wikimedia.org/wikipedia/commons/e/e0/Thulium.jpg', application: 'Used in X-ray devices and lasers.', row: 8.5, col: 15 },
        ...
        { symbol: 'Lu', name: 'Lutetium', number: 71, description: 'Lutetium is a hard, dense metal used in catalysts and cancer treatment.', trivia: 'Lutetium is one of the most expensive rare earth elements!', image: 'https://upload.wikimedia.org/wikipedia/commons/3/31/Lutetium.jpg', application: 'Used in catalysts, cancer therapy, and PET scans.', row: 8.5, col: 17 },
        {symbol: 'Hf', name: 'Hafnium', number: 72, description: 'Hafnium is a transition metal used in nuclear reactors and as an alloy in jet engines.', trivia: 'Hafnium is named after Hafnia, the Latin name for Copenhagen, where it was discovered.', image: 'https://www.chemistrylearner.com/wp-content/uploads/2017/11/Hafnium.jpg', application: 'Used in nuclear reactors, jet engines, and semiconductors.', row: 6, col: 4}, 
        {symbol: 'Ta', name: 'Tantalum', number: 73, description: 'Tantalum is a corrosion-resistant metal used in electronics and medical implants.', trivia: 'Tantalum was named after the Greek mythological figure Tantalus, due to its resistance to corrosion.', image: 'https://www.chemistrylearner.com/wp-content/uploads/2017/11/Tantalum.jpg', application: 'Used in electronics, medical implants, and aerospace components.', row: 6, col: 5},
        {symbol: 'W', name: 'Wolfram', number: 74, description: 'Wolfram, also known as Tungsten, is a dense metal used in lightbulb filaments and in heavy machinery.', trivia: 'Wolfram was named after the German word for "wolf\'s foam" due to its mineral origins.', image: 'https://www.chemistrylearner.com/wp-content/uploads/2017/11/Wolfram.jpg', application: 'Used in lightbulb filaments, electronics, and heavy machinery.', row: 6, col: 6},
        {symbol: 'Re', name: 'Rhenium', number: 75, description: 'Rhenium is a rare, dense metal used in high-temperature superalloys and catalytic converters.', trivia: 'Rhenium is one of the rarest elements on Earth.', image: 'https://www.chemistrylearner.com/wp-content/uploads/2017/11/Rhenium.jpg', application: 'Used in jet engines, catalysts, and electrical contacts.', row: 6, col: 7},
        {symbol: 'Os', name: 'Osmium', number: 76, description: 'Osmium is a hard, blue-gray metal used in electrical contacts and fountain pen tips.', trivia: 'Osmium is the densest naturally occurring element.', image: 'https://www.chemistrylearner.com/wp-content/uploads/2017/11/Osmium.jpg', application: 'Used in electrical contacts, fountain pen tips, and alloys.', row: 6, col: 8},
        {symbol: 'Ir', name: 'Iridium', number: 77, description: 'Iridium is a dense, corrosion-resistant metal used in spark plugs, thermocouples, and aircraft engines.', trivia: 'Iridium is one of the rarest elements on Earth, and has the highest density of any stable element.', image: 'https://www.chemistrylearner.com/wp-content/uploads/2017/11/Iridium.jpg', application: 'Used in spark plugs, thermocouples, and aircraft engines.', row: 6, col: 9},
        {symbol: 'Pt', name: 'Platinum', number: 78, description: 'Platinum is a precious metal used in jewelry, catalysts, and in hydrogen fuel cells.', trivia: 'Platinum is known for its resistance to corrosion and its catalytic properties.', image: 'https://www.chemistrylearner.com/wp-content/uploads/2017/11/Platinum.jpg', application: 'Used in jewelry, catalysts, and hydrogen fuel cells.', row: 6, col: 10},
        {symbol: 'Au', name: 'Gold', number: 79, description: 'Gold is a yellow precious metal used in jewelry, electronics, and as a form of currency.', trivia: 'Gold has been used by humans for thousands of years due to its beauty and rarity.', image: 'https://www.chemistrylearner.com/wp-content/uploads/2017/11/Gold.jpg', application: 'Used in jewelry, electronics, and as a store of value.', row: 6, col: 11},
        {symbol: 'Hg', name: 'Mercury', number: 80, description: 'Mercury is a toxic liquid metal used in thermometers and electrical switches.', trivia: 'Mercury is the only metal that is liquid at room temperature.', image: 'https://www.chemistrylearner.com/wp-content/uploads/2017/11/Mercury.jpg', application: 'Used in thermometers, barometers, and electrical switches.', row: 6, col: 12},
        {symbol: 'Tl', name: 'Thallium', number: 81, description: 'Thallium is a soft metal used in electronics, semiconductors, and as a pesticide.', trivia: 'Thallium is highly toxic and was once used as a poison.', image: 'https://www.chemistrylearner.com/wp-content/uploads/2017/11/Thallium.jpg', application: 'Used in electronics, semiconductors, and pesticides.', row: 6, col: 13},
        {symbol: 'Pb', name: 'Lead', number: 82, description: 'Lead is a toxic metal historically used in paints, pipes, and batteries.', trivia: 'Lead has been phased out in many applications due to its toxicity.', image: 'https://www.chemistrylearner.com/wp-content/uploads/2017/11/Lead.jpg', application: 'Used in batteries, shielding from radiation, and in leaded glass.', row: 6, col: 14},
        {symbol: 'Bi', name: 'Bismuth', number: 83, description: 'Bismuth is a brittle metal used in cosmetics, pharmaceuticals, and low-melting alloys.', trivia: 'Bismuth has a low toxicity and is often used as a safer alternative to lead in products.', image: 'https://www.chemistrylearner.com/wp-content/uploads/2017/11/Bismuth.jpg', application: 'Used in cosmetics, pharmaceuticals, and low-melting alloys.', row: 6, col: 15},
        {symbol: 'Po', name: 'Polonium', number: 84, description: 'Polonium is a highly radioactive metal used in nuclear applications and as an alpha emitter.', trivia: 'Polonium was famously used to poison former Russian spy Alexander Litvinenko.', image: 'https://www.chemistrylearner.com/wp-content/uploads/2017/11/Polonium.jpg', application: 'Used in nuclear applications and as an alpha emitter.', row: 6, col: 16},
        {symbol: 'At', name: 'Astatine', number: 85, description: 'Astatine is a highly radioactive halogen used in cancer treatment research.', trivia: 'Astatine is one of the rarest naturally occurring elements on Earth.', image: 'https://www.chemistrylearner.com/wp-content/uploads/2017/11/Astatine.jpg', application: 'Used in cancer treatment research and radiotherapy.', row: 6, col: 17},
        {symbol: 'Rn', name: 'Radon', number: 86, description: 'Radon is a radioactive gas used in cancer treatment, but is also a health hazard.', trivia: 'Radon is a leading cause of lung cancer in non-smokers.', image: 'https://www.chemistrylearner.com/wp-content/uploads/2017/11/Radon.jpg', application: 'Used in cancer treatment, but a health hazard when inhaled.', row: 6, col: 18},
        {symbol: 'Fr', name: 'Francium', number: 87, description: 'Francium is a highly radioactive alkali metal, one of the rarest naturally occurring elements.', trivia: 'Francium is so rare that only small amounts have been synthesized in laboratories.', image: 'https://www.chemistrylearner.com/wp-content/uploads/2017/11/Francium.jpg', application: 'Mainly used in scientific research due to its rarity and radioactivity.', row: 7, col: 1},
        {symbol: 'Ra', name: 'Radium', number: 88, description: 'Radium is a radioactive metal used in luminous paints, but is now mostly replaced due to health risks.', trivia: 'Radium was once used in medicine and as a source of radiation for cancer treatment.', image: 'https://www.chemistrylearner.com/wp-content/uploads/2017/11/Radium.jpg', application: 'Historically used in luminous paints and medical treatments.', row: 7, col: 2},
        {symbol: 'Ac', name: 'Actinium', number: 89, description: 'Actinium is a radioactive metal used in radiation therapy and in neutron sources.', trivia: 'Actinium was the first non-primordial radioactive element discovered.', image: 'https://www.chemistrylearner.com/wp-content/uploads/2017/11/Actinium.jpg', application: 'Used in radiation therapy and neutron sources.', row: 7, col: 3},
        {symbol: 'Th', name: 'Thorium', number: 90, description: 'Thorium is a radioactive metal used as a nuclear fuel and in high-temperature applications.', trivia: 'Thorium is considered a potential alternative to uranium for nuclear energy.', image: 'https://www.chemistrylearner.com/wp-content/uploads/2017/11/Thorium.jpg', application: 'Used as nuclear fuel and in high-temperature applications.', row: 9.5, col: 4},
        {symbol: 'Pa', name: 'Protactinium', number: 91, description: 'Protactinium is a radioactive metal used in research and nuclear fuel cycles.', trivia: 'Protactinium is one of the rarest naturally occurring elements.', image: 'https://www.chemistrylearner.com/wp-content/uploads/2017/11/Protactinium.jpg', application: 'Used in nuclear research and fuel cycles.', row: 9.5, col: 5},
        {symbol: 'U', name: 'Uranium', number: 92, description: 'Uranium is a radioactive metal used as nuclear fuel and in the production of nuclear weapons.', trivia: 'Uranium is the heaviest naturally occurring element that is still fissile.', image: 'https://www.chemistrylearner.com/wp-content/uploads/2017/11/Uranium.jpg', application: 'Used as nuclear fuel and in nuclear weapons.', row: 9.5, col: 6},
        {symbol: 'Np', name: 'Neptunium', number: 93, description: 'Neptunium is a radioactive element used in nuclear reactors and research.', trivia: 'Neptunium was the first transuranic element to be synthesized.', image: 'https://www.chemistrylearner.com/wp-content/uploads/2017/11/Neptunium.jpg', application: 'Used in nuclear reactors and scientific research.', row: 9.5, col: 7},
        {symbol: 'Pu', name: 'Plutonium', number: 94, description: 'Plutonium is a highly radioactive metal used in nuclear reactors and nuclear weapons.', trivia: 'Plutonium was named after the planet Pluto.', image: 'https://www.chemistrylearner.com/wp-content/uploads/2017/11/Plutonium.jpg', application: 'Used in nuclear reactors, weapons, and energy generation.', row: 9.5, col: 8},
        {symbol: 'Am', name: 'Americium', number: 95, description: 'Americium is a radioactive metal used in smoke detectors and nuclear batteries.', trivia: 'Americium was named after the Americas, following the tradition of naming elements after continents.', image: 'https://www.chemistrylearner.com/wp-content/uploads/2017/11/Americium.jpg', application: 'Used in smoke detectors, nuclear batteries, and research.', row: 9.5, col: 9},
        {symbol: 'Cm', name: 'Curium', number: 96, description: 'Curium is a radioactive element used in scientific research and in nuclear reactors.', trivia: 'Curium was named after Marie and Pierre Curie for their pioneering work in radioactivity.', image: 'https://www.chemistrylearner.com/wp-content/uploads/2017/11/Curium.jpg', application: 'Used in research and nuclear reactors.', row: 9.5, col: 10},
        {symbol: 'Bk', name: 'Berkelium', number: 97, description: 'Berkelium is a radioactive element used in scientific research.', trivia: 'Berkelium was named after the city of Berkeley, California, where it was first synthesized.', image: 'https://www.chemistrylearner.com/wp-content/uploads/2017/11/Berkelium.jpg', application: 'Used in scientific research and as a neutron source.', row: 9.5, col: 11},
        {symbol: 'Cf', name: 'Californium', number: 98, description: 'Californium is a radioactive element used in nuclear reactors and as a neutron source.', trivia: 'Californium was named after the state of California, where it was first synthesized.', image: 'https://www.chemistrylearner.com/wp-content/uploads/2017/11/Californium.jpg', application: 'Used in nuclear reactors and neutron sources.', row: 9.5, col: 12},
        {symbol: 'Es', name: 'Einsteinium', number: 99, description: 'Einsteinium is a synthetic, radioactive element used in scientific research.', trivia: 'Einsteinium was named after Albert Einstein in recognition of his contributions to physics.', image: 'https://www.chemistrylearner.com/wp-content/uploads/2017/11/Einsteinium.jpg', application: 'Used in scientific research, particularly in the study of nuclear reactions.', row: 9.5, col: 13},
        {symbol: 'Fm', name: 'Fermium', number: 100, description: 'Fermium is a radioactive element used in scientific research and nuclear applications.', trivia: 'Fermium was named after Enrico Fermi, a physicist known for his work in nuclear reactions.', image: 'https://www.chemistrylearner.com/wp-content/uploads/2017/11/Fermium.jpg', application: 'Used in scientific research and nuclear applications.', row: 9.5, col: 14},
        {symbol: 'Md', name: 'Mendelevium', number: 101, description: 'Mendelevium is a radioactive element used in scientific research.', trivia: 'Mendelevium was named after Dmitri Mendeleev, the creator of the periodic table.', image: 'https://www.chemistrylearner.com/wp-content/uploads/2017/11/Mendelevium.jpg', application: 'Used in scientific research and particle physics.', row: 9.5, col: 15},
        {symbol: 'No', name: 'Nobelium', number: 102, description: 'Nobelium is a synthetic radioactive element used in scientific research.', trivia: 'Nobelium was named after Alfred Nobel, the founder of the Nobel Prize.', image: 'https://www.chemistrylearner.com/wp-content/uploads/2017/11/Nobelium.jpg', application: 'Used in scientific research and nuclear chemistry.', row: 9.5, col: 16},
        {symbol: 'Lr', name: 'Lawrencium', number: 103, description: 'Lawrencium is a synthetic, radioactive element used in scientific research.', trivia: 'Lawrencium was named after Ernest O. Lawrence, the inventor of the cyclotron.', image: 'https://www.chemistrylearner.com/wp-content/uploads/2017/11/Lawrencium.jpg', application: 'Used in scientific research, particularly in particle physics.', row: 9.5, col: 17}
    ];
    ...
    const handleFunInteraction = (element) => {
        Alert.alert('Fun Interaction', `Hey! Did you know? ${element.description}`, [{ text: 'Cool!', style: 'default' }]);
    };
    ...
    return (
        <ScrollView
            contentContainerStyle={[styles.scrollContainer, { width: width, height: height }]}
            horizontal={true}  // Enable horizontal scrolling for periodic table
        ...
        >
            <View style={[styles.container, { width: width, height: height }]}>
                ...
                <ScrollView
                    contentContainerStyle={[styles.gridContainer, { width: width, height: height }]} // Enable space for all elements
